...
**Kimi K2.5 as default** — OpenAI-compatible API, cheap, fast. Provider is fully configurable via `~/.config/reflex/config.yaml` (base URL + model + API key env var). Any OpenAI-compatible endpoint works.
